...
Реестр сотрудников и кабинет руководителя: [инструкция](docs/manager-workflow.md). Администратор импортирует CSV/XLSX с рабочей почтой и связями подчинения; руководитель просматривает задачи команды и сохраняет личные фильтры.
